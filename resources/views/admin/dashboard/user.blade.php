                                ...
                                <div class="table-responsive">
                                    <table class="table table-styled mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                        <span class="img-thumb">
                                                            <img src="{{asset('assets/admin/images/table/1.jpg')}}" alt="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                        <span class="img-thumb">
                                                            <img src="{{asset('assets/admin/images/table/2.jpg')}}" alt=" ">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                        <span class="img-thumb">
                                                            <img src="{{asset('assets/admin/images/table/3.jpg')}}" alt="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                        <span class="img-thumb">
                                                            <img src="{{asset('assets/admin/images/table/7.jpg')}}" alt="">
                                                            <span class="ml-2">John</span>
                                                        </span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                        <span class="img-thumb">
                                                            <img src="{{asset('assets/admin/images/table/4.jpg')}}" alt="">
