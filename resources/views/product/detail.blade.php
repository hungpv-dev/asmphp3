                            ...
                            <div class="product__media--preview  swiper">
                                <div class="swiper-wrapper">
                                    @forelse($product->images as $img)
                                        <div class="swiper-slide" id="imageTitle">
                                            <div class="product__media--preview__items">
                                                <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{$img->url}}"><img class="product__media--preview__items--img" src="{{$img->url}}" alt="product-media-img"></a>
                                                <div class="product__media--view__icon">
                                                    <a class="product__media--view__icon--link glightbox" href="{{$img->url}}" data-gallery="product-media-preview">
                                    ...
                                    @empty
                                        <div class="swiper-slide">
                                            <div class="product__media--preview__items">
                                                <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="https://tse3.mm.bing.net/th?id=OIP.i6csXaCi4MObhfBOuxqRLgAAAA&pid=Api&P=0&h=220"><img class="product__media--preview__items--img" src="https://tse3.mm.bing.net/th?id=OIP.i6csXaCi4MObhfBOuxqRLgAAAA&pid=Api&P=0&h=220" alt="product-media-img"></a>
                                                <div class="product__media--view__icon">
                                                    <a class="product__media--view__icon--link glightbox" href="https://tse3.mm.bing.net/th?id=OIP.i6csXaCi4MObhfBOuxqRLgAAAA&pid=Api&P=0&h=220" data-gallery="product-media-preview">
                                                        <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    @foreach($product->images as $img)
                                        <div class="swiper-slide">
                                            <div class="product__media--nav__items">
                                                <img class="product__media--nav__items--img" onclick="toggleImage(this,'#imageTitle')" src="{{$img->url}}" alt="product-nav-img">
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="col">
                        <div class="product__details--info">
                            <form action="{{route('cart.add')}}" method="POST">
                                ...
                                <input type="hidden" name="property" value="{{$thuocTinh->id ?? ''}}">
                                ...
                                <div class="product__variant">
                                    <div class="product__variant--list mb-10">
                                        <fieldset class="variant__input--fieldset">
                                            ...
                                            @foreach($colors as $property)
                                                <input id="color-red{{$property->id}}" name="color" type="radio" {{$property->color == $color ? 'checked' : ''}}>
                                                <label class="btn red fs-3 pushColor" for="color-red{{$property->id}}"><a href="{{route('product.detail',[$product->slug,$product->id])}}">{{$property->color}}</a></label>
                                            @endforeach
                                        </fieldset>
                                    </div>
                                    <div class="product__variant--list mb-15">
                                        <fieldset class="variant__input--fieldset weight">
                                            <legend class="product__variant--title mb-8">Kích thước :</legend>
                                            @foreach($sizes as $property)
                                                <input id="weight{{$property->id}}" name="weight" type="radio" {{$property->size == $size ? 'checked' : ''}}>
                                                <label class="variant__size--value pushSize red" for="weight{{$property->id}}"><a href="">{{$property->size}}</a></label>
                                            @endforeach
                                        </fieldset>
                                    </div>
                                    @if(!empty($thuocTinh))
                                        @if($thuocTinh->status == 1)
                                            <div class="product__details--info__meta">
                                                <p class="product__details--info__meta--list"><span class="text-danger">(Mẫu này đã ngưng bán)</span> </p>
                                            </div>
                                        @elseif($thuocTinh->count <= 0)
                                            <div class="product__details--info__meta">
                                                <p class="product__details--info__meta--list"><span class="text-danger">(Hết hàng)</span> </p>
                                            </div>
                                        @endif
                                    @endif
                                    <div class="product__variant--list quantity d-flex align-items-center mb-20">
                                        <div class="quantity__box">
                                            <button type="button" class="quantity__value quickview__value--quantity decreases" onclick="toggleCountDown('.quickview__value--number')" aria-label="quantity value" value="Decrease Value">-</button>
                                            <label>
                                                <input type="number" readonly class="quantity__number quickview__value--number" name="count" min="1" max="{{empty($thuocTinh) ? 1 : $thuocTinh->count}}" value="1" />
                                            </label>
                                            <button type="button" class="quantity__value quickview__value--quantity increases" onclick="toggleCountUp('.quickview__value--number',)" aria-label="quantity value" value="Increase Value">+</button>
                                        </div>
                                        <button name="add-cart" class="quickview__cart--btn primary__btn"
                                            @if(empty($thuocTinh) || $thuocTinh->count <= 0 || $thuocTinh->status == 1)
                                                style="pointer-events: none; background: rgba(0,0,0,0.3)" type="submit"
                                            @endif
                                        >
                                    ...
                                    <div class="product__variant--list mb-15">
                                        ...
                                        <button name="buy-now" class="variant__buy--now__btn primary__btn" type="submit"
                                            @if(empty($thuocTinh) || $thuocTinh->count <= 0 || $thuocTinh->status == 1)
                                                style="pointer-events: none; background: rgba(0,0,0,0.3)" type="submit"
                                            @endif
                                        >Mua ngay</button>
                                ...
                                <div class="quickview__social d-flex align-items-center mb-15">
                                    <label class="quickview__social--title">Chia sẻ mạng xã hội:</label>
                                    <ul class="quickview__social--wrapper mt-0 d-flex">
                                        <li class="quickview__social--list" data-href="{{$url}}" >
                                            <a class="quickview__social--icon" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{$url}}">
                                ...
                                <div class="guarantee__safe--checkout">
                                    <h5 class="guarantee__safe--checkout__title">Hỗ trợ thanh toán</h5>
                                ...
                                <div id="reviews" class="tab_pane">
                                    <div class="product__reviews">
                                        <div class="product__reviews--header">
                                            <h2 class="product__reviews--header__title h3 mb-20">Phản hồi khác hàng</h2>
                                            <div class="reviews__ratting d-flex align-items-center">
                                                ...
                                                <span class="reviews__summary--caption">Dựa trên {{$product->comments->count()}} đánh giá</span>
                                            </div>
                                        </div>
                                        <div class="reviews__comment--area">
                                            ...
                                            <div class="reviews__comment--list d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="{{$comment->user->image->url ?? 'https://tse4.explicit.bing.net/th?id=OIP.xo-BCC1ZKFpLL65D93eHcgHaGe&pid=Api&P=0&h=220'}}" alt="comment-thumb">
                                                </div>
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex justify-content-between">
                                                        <div class="reviews__comment--top__left">
                                                            <h3 class="reviews__comment--content__title h4">{{$comment->user->name}}</h3>
                                                            <ul class="rating reviews__comment--rating d-flex">
                                                                @for($i = 0 ; $i < 5 ; $i++)
                                                                @if($i < $comment->reating)
                                                                    @php
                                                                        $fill = 'currentColor'
                                                                    @endphp
                                                                @else
                                                        ...
                                                        <span class="reviews__comment--content__date">{{$comment->created_at->format('H:i d-m-Y')}}</span>
                                                    </div>
                                        ...
                                        <div id="writereview" class="reviews__comment--reply__area">
                                            <form action="{{route('comment.store')}}" method="POST">
                                                ...
                                                <div class="reviews__ratting d-flex align-items-center mb-20">
                                                    <ul class="rating d-flex" id="reating-list">
                                                        <li class="rating__list comment">
                                                            <label for="reating1" class="rating__list--icon">
                                                                <svg class="rating__list--icon__svg" xmlns="http://www.w3.org/2000/svg" width="14.105" height="14.732" viewBox="0 0 10.105 9.732">
                                                                <path data-name="star - Copy" d="M9.837,3.5,6.73,3.039,5.338.179a.335.335,0,0,0-.571,0L3.375,3.039.268,3.5a.3.3,0,0,0-.178.514L2.347,6.242,1.813,9.4a.314.314,0,0,0,.464.316L5.052,8.232,7.827,9.712A.314.314,0,0,0,8.292,9.4L7.758,6.242l2.257-2.231A.3.3,0,0,0,9.837,3.5Z" transform="translate(0 -0.018)" fill="currentColor"></path>
                                                                </svg>
                                                            </label>
                                                            <input type="radio" name="reating" value="1" class="d-none" id="reating1">
                                                        </li>
                                                        <li class="rating__list comment" style="cursor: pointer">
                                                            <label for="reating2" class="rating__list--icon">
                                                                <svg class="rating__list--icon__svg" xmlns="http://www.w3.org/2000/svg" width="14.105" height="14.732" viewBox="0 0 10.105 9.732">
                                                                <path data-name="star - Copy" d="M9.837,3.5,6.73,3.039,5.338.179a.335.335,0,0,0-.571,0L3.375,3.039.268,3.5a.3.3,0,0,0-.178.514L2.347,6.242,1.813,9.4a.314.314,0,0,0,.464.316L5.052,8.232,7.827,9.712A.314.314,0,0,0,8.292,9.4L7.758,6.242l2.257-2.231A.3.3,0,0,0,9.837,3.5Z" transform="translate(0 -0.018)" fill="currentColor"></path>
                                                                </svg>
                                                            </label>
                                                            <input type="radio" name="reating" value="2" class="d-none" id="reating1">
                                                        </li>
                                                        <li class="rating__list comment" style="cursor: pointer">
                                                            <label for="reating3" class="rating__list--icon">
                                                                <svg class="rating__list--icon__svg" xmlns="http://www.w3.org/2000/svg" width="14.105" height="14.732" viewBox="0 0 10.105 9.732">
                                                                <path data-name="star - Copy" d="M9.837,3.5,6.73,3.039,5.338.179a.335.335,0,0,0-.571,0L3.375,3.039.268,3.5a.3.3,0,0,0-.178.514L2.347,6.242,1.813,9.4a.314.314,0,0,0,.464.316L5.052,8.232,7.827,9.712A.314.314,0,0,0,8.292,9.4L7.758,6.242l2.257-2.231A.3.3,0,0,0,9.837,3.5Z" transform="translate(0 -0.018)" fill="currentColor"></path>
                                                                </svg>
                                                            </label>
                                                            <input type="radio" name="reating" value="3" class="d-none" id="reating1">
                                                        </li>
                                                        <li class="rating__list comment" style="cursor: pointer">
                                                            <label for="reating4" class="rating__list--icon">
                                                                <svg class="rating__list--icon__svg" xmlns="http://www.w3.org/2000/svg" width="14.105" height="14.732" viewBox="0 0 10.105 9.732">
                                                                <path data-name="star - Copy" d="M9.837,3.5,6.73,3.039,5.338.179a.335.335,0,0,0-.571,0L3.375,3.039.268,3.5a.3.3,0,0,0-.178.514L2.347,6.242,1.813,9.4a.314.314,0,0,0,.464.316L5.052,8.232,7.827,9.712A.314.314,0,0,0,8.292,9.4L7.758,6.242l2.257-2.231A.3.3,0,0,0,9.837,3.5Z" transform="translate(0 -0.018)" fill="currentColor"></path>
                                                                </svg>
                                                            </label>
                                                            <input type="radio" name="reating" value="4" class="d-none" id="reating1">
                                                        </li>
                                                        <li class="rating__list comment" style="cursor: pointer">
                                                            <label for="reating5" class="rating__list--icon">
                                                                <svg class="rating__list--icon__svg" xmlns="http://www.w3.org/2000/svg" width="14.105" height="14.732" viewBox="0 0 10.105 9.732">
                                                                <path data-name="star - Copy" d="M9.837,3.5,6.73,3.039,5.338.179a.335.335,0,0,0-.571,0L3.375,3.039.268,3.5a.3.3,0,0,0-.178.514L2.347,6.242,1.813,9.4a.314.314,0,0,0,.464.316L5.052,8.232,7.827,9.712A.314.314,0,0,0,8.292,9.4L7.758,6.242l2.257-2.231A.3.3,0,0,0,9.837,3.5Z" transform="translate(0 -0.018)" fill="currentColor"></path>
                                                                </svg>
                                                            </label>
                                                            <input type="radio"  checked  name="reating" value="5" class="d-none" id="reating1">
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="row">
                                                ...
                                                <button class="reviews__comment--btn text-white primary__btn" data-hover="Submit" type="submit">Bình luẩn</button>
                                            </form>
                                            @endif
                                        </div>
                                    </div>
...
@section('script')
    <script>
        $(document).on('click','.product__details--tab__list',function(){
            let tap = $(this).data('toggle');
            let content = $(this).data('target');
            $(".product__details--tab__list").removeClass('active');
            $(this).addClass('active');
            $(tap).find('.tab_pane').removeClass('active show')
            $(tap).find(content+'.tab_pane').addClass('active show');
        });


        $(document).on('click','.pushColor',function (e){
            e.preventDefault();
            let color = $(this).find('a').text();
        ...
        $(document).on('click','.pushSize',function (e){
            e.preventDefault();
        ...
        $(document).on('click','.rating__list.comment',function(){
            let content = '';
            let id = $(this).find('input').val();
            for(let i = 0; i < 5; i++){
                let check = i < id ? 'currentColor' : '';
                let checked = i == id-1 ? 'checked' : '';
                content += `
                    <li class="rating__list comment">
                        <label for="reating${i+1}" class="rating__list--icon">
                            <svg class="rating__list--icon__svg" xmlns="http://www.w3.org/2000/svg" width="14.105" height="14.732" viewBox="0 0 10.105 9.732">
                            <path data-name="star - Copy" d="M9.837,3.5,6.73,3.039,5.338.179a.335.335,0,0,0-.571,0L3.375,3.039.268,3.5a.3.3,0,0,0-.178.514L2.347,6.242,1.813,9.4a.314.314,0,0,0,.464.316L5.052,8.232,7.827,9.712A.314.314,0,0,0,8.292,9.4L7.758,6.242l2.257-2.231A.3.3,0,0,0,9.837,3.5Z" transform="translate(0 -0.018)" fill="${check}"></path>
                            </svg>
                        </label>
                        <input type="radio" ${checked} name="reating" value="${i+1}" class="d-none" id="reating${i+1}">
                    </li>
                `;
            }
            $("#reating-list").html(content);
        })
    </script>
@endsection
