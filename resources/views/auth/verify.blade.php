...
@section('content')
    <main class="main__content_wrapper pb-5">
                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="breadcrumb__content text-center">
                            <h1 class="breadcrumb__content--title text-white mb-25">Nhận mail xác thực</h1>
                            <ul class="breadcrumb__content--menu d-flex justify-content-center">
                                <li class="breadcrumb__content--menu__items"><a class="text-white" href="{{route('home')}}">Trang chủ</a></li>
                                <li class="breadcrumb__content--menu__items"><span class="text-white">Xác thực tài khoản</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="header__search--widget header__sticky--none mt-5 d-flex justify-content-center">
            <form class="d-flex header__search--form" method="POST" action="{{route('verify.send')}}">
                @csrf
                <div class="header__search--box">
                    <label>
                        <input class="header__search--input" name="email" value="{{old('email')}}" placeholder="Email của bạn..." type="text">
                    </label>
